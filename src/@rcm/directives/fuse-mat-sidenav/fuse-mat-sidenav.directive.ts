...
import {RcmMatchMediaService} from '@rcm/services/match-media.service';
import {FuseMatSidenavHelperService} from '@rcm/directives/fuse-mat-sidenav/fuse-mat-sidenav.service';
...
export class FuseMatSidenavHelperDirective implements OnInit, OnDestroy {
     ...
     * Constructor
     *
     * @param {RcmMatchMediaService} _rcmMatchMediaService
     * @param {FuseMatSidenavHelperService} _fuseMatSidenavHelperService
     * @param {MatSidenav} _matSidenav
     * @param {ObservableMedia} _observableMedia
     */
    constructor(
        private _rcmMatchMediaService: RcmMatchMediaService,
    ...
    ngOnInit(): void {
        ...
        this._rcmMatchMediaService.onMediaChange
